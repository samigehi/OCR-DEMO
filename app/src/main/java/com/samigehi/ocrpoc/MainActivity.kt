...
//                        }
    ...
    private fun setUpTapToFocus() {
        viewFinder.setOnTouchListener { _, event ->
            Log.e("CAMERA", event.toString())
            if (event.action == MotionEvent.ACTION_DOWN) {
                val factory =
                    SurfaceOrientedMeteringPointFactory(viewFinder.width.toFloat(), viewFinder.height.toFloat())
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener(Runnable {
            ...
            try {
                ...
                //viewFinder.surfaceProvider = camera?.cameraInfo
                //viewFinder.
